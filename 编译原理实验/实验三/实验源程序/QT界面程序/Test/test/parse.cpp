...
////P394
////lineno: 977
//// if_stmt(if_stmt-->if exp then stmt-sequence end | | if exp then stmt-sequence else stmt-sequence end)
...
// if_stmt(if_stmt-->if(exp) stmt-sequence else stmt-sequence | if(exp) stmt-sequence)
TreeNode * if_stmt(void)
{
    TreeNode * t = newStmtNode(IfK);
    match(IF);
