...
* File: E:/QTproject/minicProject/testFile/source1.tm
* Standard prelude:
...
* -> Op
* -> Id
 20:     LD  2,3(5) 	get param array address
 21:    LDA  2,0(2) 	get array variable value
* <- Id
...
* -> return
* -> Id
 33:     LD  2,2(5) 	get param array address
 34:    LDA  2,0(2) 	get array variable value
* <- Id
...
* -> Op
* -> Id
 40:     LD  2,2(5) 	get param array address
 41:    LDA  2,0(2) 	get array variable value
* <- Id
...
* -> Op
* -> Id
 44:     LD  2,2(5) 	get param array address
 45:    LDA  2,0(2) 	get array variable value
* <- Id
 46:    LDA  4,-1(4) 	push prepare
 47:     ST  1,0(4) 	op: protect left
* -> Id
 48:     LD  2,3(5) 	get param array address
 49:    LDA  2,0(2) 	get array variable value
* <- Id
...
* -> Id
 55:     LD  2,3(5) 	get param array address
 56:    LDA  2,0(2) 	get array variable value
* <- Id
...
* -> Id
 65:     LD  2,3(5) 	get param array address
 66:    LDA  2,0(2) 	get array variable value
* <- Id
...
* -> assign
* -> Id
 82:    LDA  2,0(5) 	get local array address
* <- Id
...
* -> assign
* -> Id
 93:    LDA  2,-1(5) 	get local array address
* <- Id
...
Code generated in file E:/QTproject/minicProject/testFile/source1.tm
